return {
...

	{
		...
		config = function(_, opts)
			...
			vim.keymap.set("n", "<leader>sd", "<cmd>Lspsaga lsp_finder<CR>")
			...
			vim.keymap.set("n", "<leader>gra", "<cmd>Lspsaga rename ++project<CR>")
			...
			vim.keymap.set("n", "<A-k>", "<cmd>Lspsaga hover_doc ++keep<CR>")
